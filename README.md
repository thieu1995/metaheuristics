...
2. GSO (2016) - Galactic Swarm Optimization: A new global optimization metaheuristic inspired by galactic motion
3. BBBC (2006)- A new optimization method: big bang–big crunch
4. YYO (2016) - Yin-Yang-pair Optimization: A novel lightweight optimization algorithm
5. OTO (2014) - A new metaheuristic for optimization: Optics inspired optimization (OIO)
6. VPLA (2018) - 3 cites - Volleyball Premier League Algorithm
7. COOA (2016) - 5 cites - Competitive optimization algorithm
8. CDO (2017) - 5 cites - Collective decision optimization algorithm: A new heuristic optimization method
9. WWO (2015) - 136 cites - Water wave optimization: A new nature-inspired metaheuristic
10. no - ASO (2019) - 3 cites - Atom search optimization and its application to solve a hydrogeologic parameter estimation problem
 ...
```
...
5. KIA (2017) - Kidney-inspired algorithm for optimization problems
6. ITGO (2015) - ITGO: Invasive tumor growth optimization algorithm
7. fine - YSGB (2018) - 0 cites - A novel bio-inspired optimization model based on Yellow Saddle Goatfish behavior 
...
```
...
2. HS (2001) - A new heuristic optimization algorithm: harmony search
3. TLBO (2011) - Teaching–learning-based optimization: A novel method for constrained mechanical design optimization problems
4. PVS (2016) - Passing vehicle search (PVS): A novel metaheuristic algorithm
... 
```
