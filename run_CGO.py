#!/usr/bin/env python
# Created by "Thieu" at 22:07, 02/03/2022 ----------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from models.news.CGO import BaseCGO
...
## Setting parameters
obj_func = func_ackley  # Objective function (Your minimum or maximum function)
verbose = True
epoch = 1000
pop_size = 50

md1 = BaseCGO(obj_func, lb, ub, verbose, epoch, pop_size)
